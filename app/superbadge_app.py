...
class SuperBadgeApp(ctk.CTk):
    def __init__(self):
        ...
        self.btn_lasertag = ctk.CTkButton(self.sidebar_frame, text="Laser Tag", command=lambda: self.select_tab("lasertag"))
    ...
    def setup_display_tab(self):
        ...
        self.align_menu = ctk.CTkOptionMenu(opt_frame, values=["center", "left"], width=80)
        ...
        patterns = ["Solid", "Rainbow", "Breathe", "Theater Chase", "Cylon", "Twinkle", "Sparkle"]
